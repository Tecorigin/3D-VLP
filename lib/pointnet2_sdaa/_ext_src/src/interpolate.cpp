...
std::vector<at::Tensor> three_nn(at::Tensor unknowns, at::Tensor knows) {
  ...
  if (unknowns.device()==at::kPrivateUse1) {
    CHECK_SDAA(knows);
  }
...
//  }
//  std::cout << "Finish three_nn......."<< std::endl;
  return {dist2, idx};
}
...
//    AT_ASSERT(false, "CPU not supported");
//  }
//  std::cout << "Finish three_interpolate......."<< std::endl;
...
//    AT_ASSERT(false, "CPU not supported") 
// }
//  std::cout << "Finish three_interpolate_grad......."<< std::endl;
